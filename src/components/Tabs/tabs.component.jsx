...
// export default function Tabs({ defaultItem, items }) {
//   const tabId = useId();
//   const [activeTab, setActiveTab] = useState(defaultItem ?? items[0].value);
...
//           <button
//             key={itemValue + "-tab-button-" + tabId}
//             className={`px-4 py-2 font-medium ${
//               activeTab === itemValue
//                 ? "border-b-2 border-blue-500 text-blue-500"
//                 : "text-gray-500"
//             }`}
//             onClick={() => setActiveTab(itemValue)}
//           >
//             {label}
//           </button>
//         ))}
...
//           <div
//             key={itemValue + "-tab-panel-" + tabId}
//             hidden={activeTab !== itemValue}
//           >
//             {content}
//           </div>
//         ))}
